...
// 💡 تم إضافة استيراد Firestore لمعالجة نوع Timestamp
import 'package:cloud_firestore/cloud_firestore.dart'; 
import '../providers/customer_orders_provider.dart';
// 💡 تم تحديث الاستيراد ليتطابق مع اسم النموذج الجديد
...
// ----------------------------------------------------
// Widget بطاقة الطلب (OrderCard)
// ----------------------------------------------------

class OrderCard extends StatefulWidget {
  // 💡 تم تحديث نوع النموذج
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ------------------ الجزء السفلي (التفاصيل والتحديث) ------------------
              if (_isExpanded) ...[
                ...
                // 💡 التعديل الذي يحل مشكلة toLocaleString: استدعاء الامتداد على Timestamp مباشرة
                ...
                Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      // 💡 استخدام اسم الامتداد للوصول إلى allStatuses
...
// ----------------------------------------------------
// توسيع نطاق OrderStatuses (تم تسمية الامتداد)
// ----------------------------------------------------
...
// توسيع نطاق Timestamp (يعمل الآن بفضل استيراد cloud_firestore)
extension DateParsing on Timestamp {
  String toLocaleString() {
    return toDate().toString().split('.')[0];
  }
}
