...
import 'delivery_prices_menu_tile.dart'; // لا تغيير

// 💡 تم تغيير اسم الـ Widget
class DeliveryMerchantSidebarWidget extends StatelessWidget {                                     
  ...
  void _navigateTo(BuildContext context, String route) {                                            
    ...
    // 💡 الآن سيتم التوجيه إلى المسار الجديد الذي تم تعريفه في main.dart
          ...
          Expanded(                                         
            child: ListView(
              ...
              children: [                                       
                ...
                // 💡 هنا يتم استدعاء قائمة الدليفري الفرعية
                const DeliveryPricesMenuTile(),
                                                                
                // 🚀 التعديل: تغيير المسار إلى '/delivery-offers'
